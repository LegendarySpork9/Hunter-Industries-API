...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'API Clean Up', 
		@enabled=1, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'1', 
		...
		@command=N'declare @CleanUpResults table (
	[Table] varchar(255),
	Expected int,
	Actual int,
	[Match] int
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Clean Up', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
