...
namespace HunterIndustriesAPI.Services.Assistant
{
    ...
    public class VersionService
    {
        ...
        /// </summary>
        public async Task<VersionResponseModel> GetAssistantVersion(
            string assistantName,
            string assistantId)
        {
            _Logger.LogMessage(
                StandardValues.LoggerValues.Debug,
                $"VersionService.GetAssistantVersion called with the parameters {ParameterFunction.FormatParameters(new string[] { assistantName, assistantId })}.");
            ...
            try
            {
                ...
                (VersionResponseModel result, Exception ex) = await _Database.QuerySingle(
                    sql,
                    reader => new VersionResponseModel()
                    {
            ...
            _Logger.LogMessage(
                StandardValues.LoggerValues.Debug,
                $"VersionService.GetAssistantVersion returned {ParameterFunction.FormatParameters(version)}.");
            return version;
        }
        ...
        /// </summary>
        public async Task<bool> AssistantVersionUpdated(
            string assistantName,
            string assistantId,
            string version)
        {
            _Logger.LogMessage(
                StandardValues.LoggerValues.Debug,
                $"VersionService.AssistantVersionUpdated called with the parameters {ParameterFunction.FormatParameters(new string[] { assistantName, assistantId, version })}.");
            ...
            _Logger.LogMessage(
                StandardValues.LoggerValues.Debug,
                $"VersionService.AssistantVersionUpdated returned {updated}.");
            return updated;
        }
    }
}
