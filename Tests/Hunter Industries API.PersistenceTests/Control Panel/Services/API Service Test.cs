...
namespace HunterIndustriesAPI.PersistenceTests.ControlPanel.Services
{
    [TestClass]
    public class APIServiceTest
    {
        ...
        /// <summary>
        /// Creates an APIService instance with a valid (non-expired) token.
        /// </summary>
        ...
        /// <summary>
        /// Creates an APIService instance with an expired token that triggers re-authorisation.
        /// </summary>
        ...
        public async Task TestUpdateUser()
        {
            ...
            _MockAPIClient.Setup(c => c.UpdateUser(
                1,
                request))
                .ReturnsAsync((expectedUser, (ResponseModel?)null));

            APIService service = CreateService();
            (UserModel? actual, ResponseModel? _) = await service.UpdateUser(
                1,
                request);
        ...
        public async Task TestUpdateUserFailed()
        {
            ...
            APIService service = CreateService();
            (UserModel? actualUser, ResponseModel? actualResponse) = await service.UpdateUser(
                1,
                request);
        ...
        public async Task TestUpdateUserSetting()
        {
            ...
            _MockAPIClient.Setup(c => c.UpdateUserSetting(
                1,
                request))
                .ReturnsAsync((expectedSetting, (ResponseModel?)null));

            APIService service = CreateService();
            (SettingModel? actual, ResponseModel? _) = await service.UpdateUserSetting(
                1,
                request);
        ...
        public async Task TestUpdateUserSettingException()
        {
            ...
            APIService service = CreateService();
            (SettingModel? actual, ResponseModel? actualResponse) = await service.UpdateUserSetting(
                1,
                request);
        ...
        public async Task TestUpdateServer()
        {
            ...
            _MockAPIClient.Setup(c => c.UpdateServer(
                1,
                request))
                .ReturnsAsync((expectedServer, (ResponseModel?)null));

            APIService service = CreateService();
            (ServerInformationModel? actual, ResponseModel? _) = await service.UpdateServer(
                1,
                request);
        ...
        public async Task TestUpdateServerException()
        {
            ...
            APIService service = CreateService();
            (ServerInformationModel? actual, ResponseModel? actualResponse) = await service.UpdateServer(
                1,
                request);
        ...
        public async Task TestGetConfigurationEntity()
        {
            ...
            _MockAPIClient.Setup(c => c.GetConfigurationEntity<ApplicationModel>(
                "application",
                1))
                .ReturnsAsync(expected);

            APIService service = CreateService();
            ApplicationModel? actual = await service.GetConfigurationEntity<ApplicationModel>(
                "application",
                1);
        ...
        {
            _MockAPIClient.Setup(c => c.DeleteConfigurationEntity(
                "application",
                1))
                .ReturnsAsync(true);

            APIService service = CreateService();
            bool actual = await service.DeleteConfigurationEntity(
                "application",
                1);
        ...
        public async Task TestGetLogStatistics()
        {
            ...
            _MockAPIClient.Setup(c => c.GetLogStatistics(
                "user",
                1))
                .ReturnsAsync(expected);

            APIService service = CreateService();
            SharedStatisticsModel? actual = await service.GetLogStatistics(
                "user",
                1);
