...
namespace HunterIndustriesAPI.IntegrationTests.API.Controllers.Assistant
{
    ...
    public class VersionControllerTest
    {
        ...
        /// <summary>
        /// Checks whether the Get method returns a 200 status code with version data.
        /// </summary>
        [TestMethod]
        public async Task TestGet()
        {
            ...
            VersionController controller = CreateController();
        ...
        /// <summary>
        /// Checks whether the Get method returns a 200 status code with information when no data is found.
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Checks whether the Patch method returns a 200 status code when the version is updated.
        /// </summary>
        [TestMethod]
        public async Task TestPatch()
        {
            ...
            using (SqlConnection conn = new(_ConnectionString))
            {
                conn.Open();
                using (SqlCommand cmd = new(
                    "INSERT INTO [Version] ([Value]) VALUES ('3.0.0')", conn))
                {
                    cmd.ExecuteNonQuery();
                }
            }
            ...
            Assert.IsNotNull(contentResult, $"contentResult null, actionResult type={actionResult?.GetType().Name}");
            Assert.AreEqual(
                HttpStatusCode.OK,
                contentResult.StatusCode,
                $"Response body: {Newtonsoft.Json.JsonConvert.SerializeObject(contentResult.Content)}");
        }

        /// <summary>
        /// Checks whether the Patch method returns a 404 status code when no assistant exists.
        /// </summary>
        [TestMethod]
